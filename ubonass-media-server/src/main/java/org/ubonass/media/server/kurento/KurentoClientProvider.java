...
package org.ubonass.media.server.kurento;
...
public interface KurentoClientProvider {
   ...
   */
  KurentoClient getKurentoClient(KurentoClientSessionInfo sessionInfo) throws CloudMediaException;

  /**
   * add by jeffrey for One2One
   * @return
   * @throws CloudMediaException
   */
  KurentoClient getKurentoClient() throws CloudMediaException;
