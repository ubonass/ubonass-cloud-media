 ...
 */
public class CloudMediaKurentoClientSessionInfo implements KurentoClientSessionInfo {

    private String participantPrivateId;
    private String sessionId;

    public CloudMediaKurentoClientSessionInfo(String participantPrivateId,
                                              String roomName) {
        super();
