...
public class DockerManager {
    ...
    public void checkDockerEnabled(String springProfile) throws CloudMediaException {
        try {
            ...
            if ("docker".equals(springProfile)) {
                ...
                message += "make sure you include the following flags in your \"docker run\" command:" + NEW_LINE
                        + "    -e cloudmedia.recording.path=/YOUR/PATH/TO/VIDEO/FILES" + NEW_LINE
                ...
                message += "you need Docker CE installed in this machine to enable CloudMedia recording cluster. "
                        + "If Docker CE is already installed, make sure to add CloudMedia Server user to "
            ...
            log.error(message);
            throw new CloudMediaException(Code.DOCKER_NOT_FOUND, message);
        }
    }
